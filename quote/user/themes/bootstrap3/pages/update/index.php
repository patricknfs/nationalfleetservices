		...
		<div class="col-md-9">
			...
			<div class="well well-sm">	
				...
				<?php } else { ?>
					...
					<p><?php echo safe_output($language->get('This process requires that you have your item purchase code entered into the system.')); ?> <a href="<?php echo $config->get('address'); ?>/settings/licensing/"><?php echo safe_output($language->get('Click here to enter it.')); ?></a></p>
					<p><button type="submit" name="download_update" class="btn btn-info"><?php echo safe_output($language->get('Check for updates')); ?></button></p>
