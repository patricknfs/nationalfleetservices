	...
	<form method="post" action="<?php echo safe_output($_SERVER['REQUEST_URI']); ?>">
		...
		<div class="col-md-9">
			...
			<div class="well well-sm">
				...
				<p><?php echo safe_output($language->get('Username')); ?><br /><input autocomplete="off" type="text" name="username" size="30" value="<?php if (isset($_POST['username'])) echo safe_output($_POST['username']); ?>" /></p>
				<p><?php echo safe_output($language->get('Password')); ?><br /><input autocomplete="off" type="password" name="password" size="30" value="<?php if (isset($_POST['password'])) echo safe_output($_POST['password']); ?>" /></p>			
