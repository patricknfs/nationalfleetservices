		...
		<h2>
			...
			<?php if ($params->get('show_title')) : ?>
				<?php if ($params->get('link_titles') && !empty($this->item->readmore_link)) : ?>
					<a href="<?php echo $this->item->readmore_link; ?>" class="n_color"> <?php echo $this->escape($this->item->title); ?></a>
				<?php else : ?>
	...
	<?php  if ( $images->image_fulltext_caption != '' ) ://<-- VIMEO-YOUTUBE-SLIDER-MAP	?>
		...
		switch( $vg_caption_cont[0] ){
			...
			case 'slide':
				...
				echo '<div class="n_carousel_with_captions_wrapper vg-slideshow-article vg-slide-article-wrapper-' . $item->id . '">
					<div class="n_carousel_with_captions vg-slide-article-' . $item->id . '">';
				...
				jQuery(document).ready(function($){
					$(".vg-slide-article-' . $item->id . '").carouFredSel({
						responsive: true,
							prev: {
							button : function(){
							return $(".vg-slide-article-wrapper-' . $item->id . '").next().children("a:first-child")
						}
					},
					next:{
						button : function(){
							return $(".vg-slide-article-wrapper-' . $item->id . '").next().children("a:last-child")
						}
					},
					width: "100%",
					circular: false,
