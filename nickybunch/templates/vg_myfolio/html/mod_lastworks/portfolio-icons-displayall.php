...
if(count($articles)) {//<-- A1.
	...
	echo '<div class="' . $moduleclass_sfx . ' element clearfix col1-3 all menu-portfolio-' . $id_ . ' section-' . $module->position . '">
      <div class="images"><img src="' . JURI::base() . 'templates/vg_myfolio/images/portfolio.jpg" alt="" /></div>
	...
	foreach($articles as $article) {//<--A5.
		...
		echo '<div class="' . $moduleclass_sfx . ' element clearfix col1-3 all auto category-' . $article->catid . '-module-' . $id_ . ' section-' . $module->position . '"> 
			' . $vg_image_full_ . '
				<div class="images">
					' . $vg_img_ . '
					' . $vg_icon_ . '
