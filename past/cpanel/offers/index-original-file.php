...
<table width="98%"  border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
   ...
   <tr>
    ...
    <td colspan="2" class="bText">
      ...
      <input type="radio" name="finance_type" value="3" align="absmiddle"  <?php if($ofrDetail['finance_type']==3) echo 'checked';?> >
      Commercial&nbsp;&nbsp;
      <input type="radio" name="finance_type" value="4" align="absmiddle"  <?php if($ofrDetail['finance_type'] == 4) echo 'checked';?> >
      &nbsp;Daily Rental</td>
  </tr>
  <tr>
  ...
  <tr>
	...
	<img src="<?php echo SITE_OFFERS_IMAGES.$ofrDetail['offer_image']?>" width="150px" height="100">
	<?php } ?>
	<input name="thumb_old" type="hidden" class="txtBox" id="category_thumb_old" value="<?php echo $ofrDetail['offer_image']?>"></td>
  </tr>
  <tr>
  ...
  <tr>
	...
	<input name="offer_price" type="text" class="textbox" maxlength="10" style="width:50px;" value="<?php echo $ofrDetail['offer_price']?>">
	 &nbsp;&nbsp;<input type="radio" name="price_type" value="1" align="absmiddle"  <?php if($ofrDetail['price_type'] == 1) echo 'checked';?>>
	 Monthly&nbsp;&nbsp;
      <input type="radio" name="price_type" value="2" align="absmiddle"  <?php if($ofrDetail['price_type'] == 2) echo 'checked';?> >
      Weekly&nbsp;&nbsp;
      <input type="radio" name="price_type" value="3" align="absmiddle"  <?php if($ofrDetail['price_type'] == 3) echo 'checked';?> >
      &nbsp;Daily </td>
  </tr>
  ...
  <tr>
    <td align="right">&nbsp;</td>
    <td>&nbsp;</td>
    <td colspan="2"><input name="Submit" type="submit" class="Button1" value="<?php echo $button?>">
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input name="set" type="reset" class="Button1" value="Cancel" onClick="javascript: history.go(-1);"></td>
  </tr>
  <tr>
    <td align="right" class="tdSubTxt">&nbsp;</td>
    <td>&nbsp;</td>
