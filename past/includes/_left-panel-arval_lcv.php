...
include("newincludes/arval_search_lcv.php"); 
...
function display_data(id) {  
    ...
    var url="newincludes/findmodel_lcv.php"; 
...
<table width="200" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td class="search-bg"><form action="searchresult-al-lcv.php" method="get" name="searchfrm" id="search" onsubmit="">
        <p class="psearch"><strong>Search By Van Manufacturer</strong></p>
...
`ratebook_arval_lcv`.`Model`
FROM
`ratebook_arval_lcv`
WHERE
`ratebook_arval_lcv`.`Manufacturer` = '$manufacturer2'";
