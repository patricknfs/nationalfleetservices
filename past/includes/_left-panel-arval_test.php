...
<table width="200" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td class="search-bg"><form action="searchresult-al_test.php" method="get" name="searchfrm" id="search" onsubmit="">
 ...
 <option <? if(($_GET['make_id']) == $info['Manufacturer']){echo "selected ";} ?>value="<? echo($info['Manufacturer']) ?>" ><? echo($info['Manufacturer']) ?></option>
       ...
       <!-- <p class="psearch"><strong>Search By Price Band</strong></p>
        ...
        <p class="psearch">Keywords:<br />
        <input type="text" name="keywords" id="keywords" value="<? if($_GET['keywords'] != "") {echo($keywords);} ?>" size="6" />
