 ...
 */
$notificationSubject = 'Multi form test 1';
 ...
 * Validators: (None)
 */
$phone = new iPhorm_Element('phone');               // Create the phone element
 ...
 * Validators: (None)
 */
$subject = new iPhorm_Element('subject');             // Create the subject element
