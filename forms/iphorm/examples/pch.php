...
<link rel="stylesheet" type="text/css" href="../css/twocol.css" /><!-- Standard form layout -->
...
<div class="outside">
    ...
    <div class="iphorm-outer">
        <form class="iphorm" action="process-pch.php" method="post" enctype="multipart/form-data">
            <div class="iphorm-wrapper">
                ...
                <div class="iphorm-inner">
                    <div class="iphorm-title">All form elements example</div>
