...
<!-- Title -->
<title>Forgot your password? | Fleet Street</title>	
...
<h2 class="entry-title">Problem logging in?</h2>

<div class="entry-content">

<h3>Please use the form below to reset your password</h3>

<h5>If you are having problems with the fleet management system please call 0121 45 45 645</h5>

<div class="divform">

<form id="contact" name="demo" onsubmit="return validateFormOnSubmit(this)" action="enquire/987654321.php">

<table border="0" width="100%" cellpadding="0" id="tableform">

	<tr>
		<td><label for="name">Username: <span class="red">*</span></label>
		<input name="name" id="name" size="35" maxlength="50" type="text">
		<input type="hidden" name="i" id="i" value="passwordrecoverysent.php" /></td>
	</tr>
	<tr>
		<td>
		<input style="height: 30px;" value="Reset Password"  src="images/btn_submit.png" type="submit"></td>
	</tr>
		<tr>
		<td></td>
		<td></td>
